...
const Hero = () => {
  ...
  return (
   ...
   <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28'>
      ...
      <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-10">The New Arirval</span>
      <br />
      <span className="text-coral-red inline-block mt-3">Nike</span>Shoes
       
      </h1 >
      <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14
       sm:max-w-sm">Discover stylish Nike arrivals, quality comfort, and innovations for your active life.</p>
